        ...
        <div class="main-content px-5 pt-4">
            <div class="row mb-3">
                <div class="col border-bottom border-danger pb-2">
                    <h1 class="fs-2 fw-bold">Solo Parents' Report (Nature)</h1>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col mb-3">
                    <div class="card reportBody">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php $populationPerNature = getPopulationPerNatureOfSoloParent(false)?>
                                    <tr>
                            ...
                            <p>The report concluded that majority of the nature of solo parent is being <b class="fw-bold"><?=getLeadingNatureOfSoloParent()?>.</b></p>
                        </div>
                    </div>
                </div>
            </div>
